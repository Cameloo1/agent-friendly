...
const requiredFiles = [
  ...
  "plugins/is-it-agent-ready/src/report-viewer.mjs",
...
if (codex.version !== claude.version || codex.version !== "1.2.0") fail("Manifest versions disagree.");
...
for (const heading of ["## Codex", "## Claude Code", "## OpenCode", "## Saving scans", "## Safety boundaries", "## Limitations", "## License"]) {
